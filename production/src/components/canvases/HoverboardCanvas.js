...
const HoverboardCanvas = (props) => {
  ...
  return (
    <div className="canvas-hoverboard">
      <Interface
      ...
      />
      <Canvas id="Hoverboard_canvas" shadows>
        ...
        <Suspense fallback={Loading}>
          ...
          <Float
            ...
            speed={4}
          >
            <Hoverboard name={props.match.params.key} />
          </Float>
...
export default HoverboardCanvas;
